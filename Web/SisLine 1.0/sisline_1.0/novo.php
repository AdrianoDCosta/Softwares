		...
		<form method="POST" action="adicionar_venda.php">
			...
			<table>
				...
				<tr>
					...
					</td><td rowspan="9" class="tdvazio"><textarea name="observacao" rows="16" class="tdvazio"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Funcionário: </td><td class='tdvazio'><input type="text" name="funcionario" class="tdvazio"></td>
				</tr>
			</table><br />
