<html>
	...
	<?php
		...
		if(!isset($_SESSION["usuario"]) || !isset($_SESSION["senha"])) {
			...
			$query = mysql_query("SELECT * FROM clientes WHERE codigo LIKE '$codigo'");
			$mostrar = mysql_fetch_array($query);
			
	?>
			
		<form method="GET" action="atualizar_cliente.php">
		<h2>.: Atualizar Cliente</h2><br /><br />
		<hr><br />
				
		<table>
			<tr>
				<td colspan="3" class="tdopcoes"><a href="exibir_clientes.php" title="Cancelar"><img src="imagens/btn/cancelar.png" alt="Cancelar"></a>
				&nbsp
